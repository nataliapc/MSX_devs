 ...
 *                Happy listening!
 *                
 *                v1.8 TSX support added by Natalia Pujol. Join the discussion at http://www.zonadepruebas.com/viewtopic.php?f=4&t=5369
 *                
 */
...
#define PCD8544   1
  ...
  #include "U8glib.h"
  U8GLIB_PCD8544 u8g(4,5,2);    // SPI Com: SCK = 13, MOSI = 11, CE = 4, DC = 5, Reset = 2
  char line0[17];
  char line1[17];
  #define backlight_pin 3
#endif

//Enable/disable MSX blocks (Kansas City Standard 4B blocks)
#define TSX_ENABLED
//#define TSX_SPEEDUP
